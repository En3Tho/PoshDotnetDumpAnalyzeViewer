...
public sealed record DumpHeapOutputLine(string Line, DumpHeapIndexes Indexes) : OutputLine(Line), IOutputLine<DumpHeapOutputLine>, IMethodTable, IAddress
{
    public override string ToString() => Line;
...
public sealed record DumpHeapStatisticsOutputLine(string Line, DumpHeapStatisticsIndexes Indexes) : OutputLine(Line), IOutputLine<DumpHeapStatisticsOutputLine>, IMethodTable, ITypeName
{
    public override string ToString() => Line;
    public ReadOnlyMemory<char> MethodTable => Line.AsMemory(Indexes.MethodTable);
